    ...
    return (
        <div>
            ...
            <div className="flex flex-col justify-center items-center">
                <div className="mt-[16.23px] text-[#0f0f0f] text-4xl font-bold">user1234</div>
                ...
                <div className="p-[20px_18px]">
                    <div className="p-[0px_50px] flex flex-col justify-center items-center">
                        <img
                            ...
                            alt="PenIcon"
                            className="mb-[10px]"/>
                        <div className="text-xl font-medium text-[#8a8a8a]">필사 중인 글</div>
                    </div>
                </div>
                <div className="p-[20px_18px]">
                    <div className="p-[0px_50px] flex flex-col justify-center items-center">
                        <img
                            ...
                            alt="CheckIcon"
                            className="mb-[10px]"/>
                        <div className="text-xl font-medium text-[#8a8a8a]">필사 완료된 글</div>
                    </div>
                </div>
                <div className="p-[20px_18px]">
                    <div className="p-[0px_50px] flex flex-col justify-center items-center">
                        <img
                            ...
                            alt="HeartIcon"
                            className="mb-[10px]"/>
                        <div className="text-xl font-medium text-[#8a8a8a]">스크랩 한 글</div>
                    </div>
                </div>
                <div className="p-[20px_18px]">
                    <div className="p-[0px_50px] flex flex-col justify-center items-center">
                        <img
                            ...
                            alt="MemoIcon"
                            className="mb-[10px]"/>
                        <div className="text-xl font-medium text-[#8a8a8a]">메모 모아보기</div>
                    </div>
                </div>
            </div>
        </div>
